...
function Section2() {
    ...
    return (
        <div className="py-12  px-6 ">
            ...
            {/* Cards Section */}
            <div className="mt-8 grid lg:w-[70%] grid-cols-1 md:grid-cols-3 gap-6 mx-auto text-center">
                {/* Card 1 */}
                <div
                ...
                >
                    <div className="h-60 bg-gray-300 flex items-center justify-center text-2xl font-bold relative">
                        <video
                ...
                >
                    <div className="h-60 bg-gray-300 flex items-center justify-center text-2xl font-bold relative">
                        <video
                            ...
                            className="absolute top-0 left-0 w-full h-full object-cover hidden group-hover:block"
                            src="/brainbox vedio.mp4" // Replace with your video file path
                            muted={isMuted}
                            loop
                            autoPlay
                        ></video>
