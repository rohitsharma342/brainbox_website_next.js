...
export default function BlogPage() {
    ...
    return (
        <div className="container w-[80%] mt-20 mx-auto px-4 py-10 text-center">
            ...
            {blogs.length > 0 && (
                <Link href={`/blog/${blogs[0].ID}`} className="mt-10 flex flex-col md:flex-row text-start bg-purple-200 rounded-xl hover:shadow-xl cursor-pointer transition duration-300">
                    <img
    ...
    <Link href={`/blog/${blog.ID}`} key={blog.ID} legacyBehavior>
